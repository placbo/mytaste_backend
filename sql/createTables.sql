...
CREATE TABLE `reviews` (
    `reviewId` int unsigned NOT NULL AUTO_INCREMENT, `itemId` int unsigned NOT NULL, `user` varchar(255) NOT NULL, `comment` varchar(1000) NOT NULL, `rating` int DEFAULT NULL, PRIMARY KEY (`reviewId`)
);